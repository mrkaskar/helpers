import { appendElementToArray } from './append-element-to-array';
import { insertElementIntoArray } from './insert-element-into-array';
import { prependElementToArray } from './prepend-element-to-array';
...
describe('Array Manipulation Functions', () => {
  describe('insertElementIntoArray', () => {
    ...
    it('should throw an error if the index is out of bounds', () => {
      const arr = [1, 2, 3];
      expect(() => insertElementIntoArray(arr, 4, 5)).toThrowError(
        'Index out of bounds'
      );
    });
  });
  ...
  describe('removeElementFromArrayAtIndex', () => {
    ...
    it('should throw an error if the index is out of bounds', () => {
      const arr = [1, 2, 3];
      expect(() => removeElementFromArray(arr, 5)).toThrowError(
        'Index out of bounds'
      );
    });
  });
